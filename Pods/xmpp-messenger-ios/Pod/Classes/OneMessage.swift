...
public protocol GroupMessageDelegate {
...
public class OneMessage: NSObject {
  ...
  public var delegateGroupMessage: GroupMessageDelegate?
...
extension OneMessage: XMPPStreamDelegate {
  ...
  public func xmppStream(sender: XMPPStream, didReceiveMessage message: XMPPMessage) {
    ...
    if type == "groupchat" {
      ...
      if let name = message.elementForName("body") {
        messages = message.elementForName("body").stringValue()
      }
      
      let name = message.attributeForName("from").stringValue()
      
      dictGroupMessage.updateValue(name, forKey: "sender")
      
      print(dictGroupMessage)
      OneMessage.sharedInstance.delegateGroupMessage?.messageReceived(["message": messages, "sender": name])
    }
    else{
